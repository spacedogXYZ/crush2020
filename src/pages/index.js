      ...
      <GridContainer>
        <Grid row gap className="usa-graphic-list__row">
          <Grid tablet={{ col: true }} className="usa-media-block">
            ...
            <div className="usa-media-block__body">
              <h2 className="usa-graphic-list__heading">Vote</h2>
              <p>
                Every vote counts. Yes, even in your “safe” state. It’s a
                privilege &mdash; so use it.
              </p>
            </div>
          </Grid>
          <Grid tablet={{ col: true }} className="usa-media-block">
            ...
            <div className="usa-media-block__body">
              <h2 className="usa-graphic-list__heading">Time</h2>
              <p>
                Lending your special skills can make the difference between a
                campaign win and loss.
              </p>
            </div>
          </Grid>
        </Grid>
        <Grid row gap className="usa-graphic-list__row">
          <Grid tablet={{ col: true }} className="usa-media-block">
            ...
            <div className="usa-media-block__body">
              <h2 className="usa-graphic-list__heading">Donations</h2>
              <p>
                With so many campaigns saying no to corporate money, your
                dollars mean more than ever.
              </p>
            </div>
          </Grid>
          <Grid tablet={{ col: true }} className="usa-media-block">
            ...
            <div className="usa-media-block__body">
              <h2 className="usa-graphic-list__heading">Reach</h2>
              <p>
                Your world is more than what’s outside your window &mdash;
                engage the full scope of your network for lasting change.
              </p>
            </div>
          </Grid>
        </Grid>
